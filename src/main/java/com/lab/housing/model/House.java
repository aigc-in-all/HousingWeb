...
public class House {
	...
	public String toString() {
		return "House [buildName=" + buildName + ", buildRegion=" + buildRegion + ", houseType=" + houseType + ", houseArea=" + houseArea + ", houseFloor=" + houseFloor + ", rentTyep=" + rentTyep
				+ ", rentRoom=" + rentRoom + ", rentPrice=" + rentPrice + ", img=" + img + ", url=" + url + ", abbr=" + abbr + "]";
	}
